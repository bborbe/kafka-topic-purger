...
IMAGE ?= bborbe/kafka-topic-purger
...
format:
	...
	go run github.com/incu6us/goimports-reviser/v3@$(GOIMPORTS_REVISER_VERSION) -project-name github.com/bborbe/kafka-topic-purger -format -excludes vendor ./...
